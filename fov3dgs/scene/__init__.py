...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0], fps_mode=False):
        """b
        ...
        if not self.loaded_iter:
            ...
            if scene_info.train_cameras and not fps_mode:
        ...
        if fps_mode:
            for view in self.getTestCameras():
